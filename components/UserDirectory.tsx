...
const UserDirectory: React.FC<UserDirectoryProps> = ({ users }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredUsers.length === 0 ? (
            ...
            filteredUsers.map(user => (
              <div key={user.id} className="bg-white p-5 rounded-3xl border-2 border-slate-50 hover:border-indigo-100 transition-all group shadow-sm flex items-center gap-4">
